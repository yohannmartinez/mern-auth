    ...
    return (
        <div className="searchBar__container">
            <div className="searchBar__menuContainer" onClick={() => {
                ...
                <img src={Menu} className="colorToFilterBase" />
            </div>
            ...
            <div className="searchBar__clearInput colorToFilterBase" onClick={()=>{props.setSelectedSpot(null); props.onSelectSpot("")}}><img src={Cross}/></div>
